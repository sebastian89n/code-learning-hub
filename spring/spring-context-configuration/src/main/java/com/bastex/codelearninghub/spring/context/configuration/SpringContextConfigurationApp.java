...
import com.bastex.codelearninghub.spring.context.configuration.services.ConfigurationInitializedPrototypeBean;
...
public class SpringContextConfigurationApp {
    public static void main(final String[] args) {
        ...
        applicationContext.register(SpringContextConfiguration.class);
