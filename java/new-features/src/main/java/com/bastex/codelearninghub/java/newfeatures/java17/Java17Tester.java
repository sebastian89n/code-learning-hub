package com.bastex.codelearninghub.java.newfeatures.java17;

import com.bastex.codelearninghub.java.newfeatures.java17.model.Employee;
import com.bastex.codelearninghub.java.newfeatures.java17.model.Manager;
import com.bastex.codelearninghub.java.newfeatures.java17.records.UserRecord;
import com.bastex.codelearninghub.java.newfeatures.java17.sealedclasses.Celestial;
import com.bastex.codelearninghub.java.newfeatures.java17.sealedclasses.RectangleFilled;
import com.bastex.codelearninghub.java.newfeatures.java17.sealedclasses.Shape;
...
public final class Java17Tester {
    public static void testJava17Features() {
        ...
        // Java 15 has brought a few interesting additions:
        //
        ...
        log.info(userRecord.firstName());
        log.info(userRecord.lastName());
        log.info("User: {}", userRecord);

        // enhanced instanceof
        final Employee employee = new Manager("John", "Smith", 5000, 850);
        if (employee instanceof final Manager manager) {
            log.info("Bonus salary for manager: {}", manager.getBonusSalary());
        }
